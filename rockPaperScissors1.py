...
while True:
    firstPlayer = input("first player please enter your choice:")
    secondPlayer = input("second player please enter your choice:")
    if firstPlayer ==  secondPlayer :
        print('even score')
    elif firstPlayer == 1 and secondPlayer == 3 :
        print("first player wins")
    elif secondPlayer == 1 and firstPlayer == 3:
        print("second player wine")
    elif firstPlayer > secondPlayer:
        print("first player wins")
    else:
        print("second player wine")

    playAgain = input("do you want to play again? press n to finish the game otherways press any key")
